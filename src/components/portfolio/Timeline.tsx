...
const timelineData: TimelineItem[] = [
  ...
  },
  {
    ...
    description:
      "La plateforme de vente de voitures 'CarShow' permet de gérer les ventes de voitures en ligne. Les utilisateurs peuvent voir les voitures disponibles, les détails de chaque voiture, et effectuer des achats en ligne.",
  ...
  },
  {
    ...
    description:
      "Développement d'une plateforme d'échange de cryptomonnaies pour les utilisateurs de Seramoney. La plateforme permet aux utilisateurs d'acheter, vendre et échanger des cryptomonnaies de manière sécurisée et rapide, manuellement ou automatiquement.",
  ...
  },
  {
    ...
    description:
      "Application mobile de lecture des sons sur le téléphone, et classement des playlists selon les genres de musique.",
    tags: ["React", "CI"],
...
export const Timeline = () => {
  ...
  // Ferme l'aperçu si on clique n'importe où ailleurs sur la page
  useEffect(() => {
    if (openPreview === null) return;
    const handleClickOutside = () => setOpenPreview(null);
      ...
      <div className="container mx-auto px-6 max-w-5xl">
        <div className="text-center mb-16 reveal">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Un parcours jalonné de projets concrets, de collaborations
            enrichissantes et d'apprentissages continus.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-14 reveal">
          {(
            Object.entries(categoryConfig) as [
              TimelineCategory,
              (typeof categoryConfig)[TimelineCategory],
            ][]
          ).map(([key, cfg]) => (
            <div
              key={key}
        ...
        <div className="relative">
          ...
          <div className="flex flex-col gap-8">
            {timelineData.map((item, index) => {
              ...
              const isPreviewOpen = openPreview === item.id;
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className="card-surface rounded-xl p-6 hover:border-primary/30 transition-all duration-300 group relative">
                      {/* Badge catégorie */}
                      ...
                      {/* Liens : toujours au-dessus, jamais recouverts */}
                      <div
                        className={`relative z-10 flex flex-wrap gap-4 items-center ${isLeft ? "md:justify-end" : ""}`}
                      >
                        {item.liveUrl && (
                          <a
                            href={item.liveUrl}
                      ...
                      {/* Tags : toujours visibles, jamais recouverts */}
                      <div
                        className={`relative z-10 flex flex-wrap gap-4 mt-5 ${isLeft ? "md:justify-end" : ""}`}
                      >
                        {item.tags.map((tag) => {
                          const TagIcon = techIcons[tag];
